...
SofiaPos=rbind(PosACA2.11,PosACB2.11,PosACA2.17,PosACB2.17,PosASCA2.13,PosCWA2.3,PosCWB2.3,PosPNA2.10,PosPNB2.10,PosRDA2.12,PosRDB2.12)

SofiaPos=t(SofiaPos)
edit(SofiaPos)

write.xlsx(SofiaPos,"/Users/bradlide/Desktop/Data/2Sofia/SofiaCompiledPositive.xlsx",sheetName="Pos")
