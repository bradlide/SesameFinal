...
PawPos=rbind(PosACA2.11,PosACB2.11,PosACA2.17,PosACB2.17,PosASCA2.13,PosCWA2.3,PosCWB2.3,PosPNA2.10,PosPNB2.10)

PawPos=t(PawPos)
edit(PawPos)


RDA2.12=read.xlsx("QRosiesDaycare_Paw1.2.12.14_BL.xlsx",1)
RDA2.12=t(RDA2.12)
PosRDA2.12=data.frame(RDA2.12t[c(8,11,14,17,20,23),])
PosRDA2.12=data.matrix(PosRDA2.12)
PosRDA2.12=PosRDA2.12-1
PosRDA2.12=colSums(PosRDA2.12,na.rm=T)

RDB2.12=read.xlsx("QRosiesDaycare_Paw1.2.12.14_BL.xlsx",1)
RDB2.12=t(RDB2.12)
PosRDB2.12=data.frame(RDB2.12t[c(8,11,14,17,20,23),])
PosRDB2.12=data.matrix(PosRDB2.12)
PosRDB2.12=PosRDB2.12-1
PosRDB2.12=colSums(PosRDB2.12,na.rm=T)

write.xlsx(PawPos,"/Users/bradlide/Desktop/Data/2Paw/PawCompiledPositive.xlsx",sheetName="Pos")
