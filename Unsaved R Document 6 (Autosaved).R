...
ACA2.11=read.xlsx("Angels Care Sofia St A 2-11-14.xlsx",1)
ACA2.11t=t(ACA2.11)
...
LaughACA2.11=c(11:20)





ACB2.11=read.xlsx("Angels Care Sofia St B 2-11-14.xlsx",1)
ACB2.11t=t(ACB2.11)
...
SofiaLaugh=rbind(LaughACA2.11)
SofiaLaugh=rbind(LaughACB2.11)
SofiaLaugh
...
ACB2.17=read.xlsx("AngelsCare_Sofia2.2.17.14_BL (Video Label is Sofia3-4).xlsx",1)
ACB2.17t=t(ACB2.17)
...
ASCA2.13=read.xlsx("AustinSouthChristianAcademy_Sofia1.2.13.14_BL.xlsx",1)
...
CWB2.3=read.xlsx("CreativeWorld_Sofia2.2.3.14_BL (Video Label is Sofia 3-4).xlsx",1)
CWB2.3t=t(CWB2.3)
...
PNA2.10=read.xlsx("Papa and Nana's Sofia St A 2-10-14.xlsx",1)
PNA2.10t=t(PNA2.10)
...
PNB2.10=read.xlsx("Papa and Nana's Sofia St B 2-10-14.xlsx",1)
PNB2.10t=t(PNB2.10)
...
SofiaLaugh=rbind(LaughACA2.11,LaughACB2.11,LaughACA2.17,LaughACB2.17,LaughASCA2.13,LaughCWA2.3,LaughCWB2.3,LaughPNA2.10,LaughPNB2.10)
